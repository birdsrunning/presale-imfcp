...
export async function POST() {
  try {
    ...
    const subject = "A secret project for our inner circle…";
    ...
    <div style="background:#0B0B0B; padding:40px 20px; font-family:system-ui, sans-serif;">
      ...
      ">
        ...
        <h1 style="font-size:24px; margin-bottom:10px;">
          A secret project for our inner circle…
        </h1>
        ...
        <p style="color:rgba(255,255,255,0.7);">
          Over the past few months, we’ve been building something quietly.
        </p>

        <p style="color:rgba(255,255,255,0.7);">
          A visual library that actually meets a designer’s standards — 
          no artifacts, no strange proportions, no “AI look”.
          Just clean, high-impact imagery you can confidently use in real work.
        </p>

        <p style="color:rgba(255,255,255,0.7);">
          It’s called the <strong style="color:#fff;">IMFC AI Premium Package</strong>.
        </p>

        <p style="color:rgba(255,255,255,0.7);">
          Before we release it publicly, I wanted to give you first access.
        </p>
        ...
        <p style="color:rgba(255,255,255,0.7);">
          Because you’ve been here early, you can get it now at 
          <strong style="color:#fff;">20% off</strong>.
        </p>

        <p style="color:rgba(255,255,255,0.7);">
          This price is only available for the next <strong style="color:#fff;">3 days</strong>.  
          After that, it goes up when we launch publicly.
        </p>

        <p style="color:rgba(255,255,255,0.7);">
          If you’ve been waiting for something like this — this is your window.
        </p>

        <p style="margin-top:20px; color:rgba(255,255,255,0.7);">
          <strong style="color:#fff;">P.S.</strong> Once we launch publicly, this won’t be available at this price again.
        </p>
